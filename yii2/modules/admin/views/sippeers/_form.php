...
<div class="sippeers-form">
    ...
    <?= $form->field($model, 'transport')->dropDownList([ 'udp' => 'Udp', 'tcp' => 'Tcp', 'tls' => 'Tls', 'ws' => 'Ws', 'wss' => 'Wss', 'udp,tcp' => 'Udp,tcp', 'tcp,udp' => 'Tcp,udp', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'dtmfmode')->dropDownList([ 'rfc2833' => 'Rfc2833', 'info' => 'Info', 'shortinfo' => 'Shortinfo', 'inband' => 'Inband', 'auto' => 'Auto', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'directmedia')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', 'nonat' => 'Nonat', 'update' => 'Update', 'outgoing' => 'Outgoing', ], ['prompt' => '']) ?>
    ...
    <?= $form->field($model, 'trustrpid')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'progressinband')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', 'never' => 'Never', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'promiscredir')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'useclientcode')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>
    ...
    <?= $form->field($model, 'allowoverlap')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'allowsubscribe')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'videosupport')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'maxcallbitrate')->textInput() ?>

    <?= $form->field($model, 'rfc2833compensate')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'mailbox')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'session-timers')->dropDownList([ 'accept' => 'Accept', 'refuse' => 'Refuse', 'originate' => 'Originate', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'session-expires')->textInput() ?>

    <?= $form->field($model, 'session-minse')->textInput() ?>

    <?= $form->field($model, 'session-refresher')->dropDownList([ 'uac' => 'Uac', 'uas' => 'Uas', ], ['prompt' => '']) ?>
    ...
    <?= $form->field($model, 'sendrpid')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>
    ...
    <?= $form->field($model, 'constantssrc')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'contactpermit')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'contactdeny')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'usereqphone')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'textsupport')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'faxdetect')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'buggymwi')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>
    ...
    <?= $form->field($model, 'hasvoicemail')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'subscribemwi')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'vmexten')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'autoframing')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'rtpkeepalive')->textInput() ?>

    <?= $form->field($model, 'call-limit')->textInput() ?>

    <?= $form->field($model, 'g726nonstandard')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'ignoresdpversion')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'allowtransfer')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'dynamic')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'path')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'supportpath')->dropDownList([ 'yes' => 'Yes', 'no' => 'No', ], ['prompt' => '']) ?>
